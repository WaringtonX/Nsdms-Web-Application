        ...
        >
            <div class="layout-config-panel flex flex-column">
                <div class="px-3 pt-3">
                    ...
                    <span
                        >NSDMS offers different themes for layout, topbar, menu
                        etc.</span
                    >
                </div>
...
export class AppConfigComponent implements OnInit {
    ...
    ngOnInit() {
        this.themes = [
            { name: "indigo", color: "#977949" },
            { name: "pink", color: "#E91E63" },
            { name: "purple", color: "#9C27B0" },
            { name: "deeppurple", color: "#977949" },
    ...
    onLayoutModeChange(event, mode) {
        ...
        if (mode === "dark") {
            ...
            appLogoLink.src = "assets/layout/images/logo2x.png";
        } else {
