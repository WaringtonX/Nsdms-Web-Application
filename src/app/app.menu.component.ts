...
export class AppMenuComponent implements OnInit {
    ...
    constructor(public app: AppComponent,private mersetaservice: MersetaService ) {}
            ...
            this.model = [
                {
                    ...
                    items: [
                        {label: 'Dashboard ', icon: 'pi pi-fw pi-home', routerLink: ['/main/dashboard'], badge: '', badgeClass: 'p-badge-info'},
                ...
                },
                {
                    label: '', icon: 'pi pi-fw pi-home',
                    items: [
                        {label: 'Tasks', icon: 'pi pi-fw pi-align-left', routerLink: ['/main/tasklist']  , badge: '', badgeClass: 'p-badge-info'},
                        //{label: 'Dashboard Analytics', icon: 'pi pi-fw pi-home',
                        //    routerLink: ['/favorites/dashboardanalytics'], badge: '2', badgeClass: 'p-badge-success'}
                    ]
                },
                ...
                {
                    label: '', icon: 'pi pi-fw pi-user-edit',
                    items: [
                        {
                            label: 'Learner Management ', icon: 'pi pi-fw pi-user-edit',
                            items: [
                                /*{
                                    label: 'New Learner Application', icon: 'pi pi-fw pi-user',routerLink: ['/newlearner'] }, */
                                {
                                    label: 'Application', icon: 'pi pi-fw pi-users', routerLink: ['/main/learnership']  
                                },
                                {
                                    label: 'Learners', icon: 'pi pi-fw pi-users', routerLink: ['/main/learners']  
                                },  
                                // {
                                //     label: 'Process List', icon: 'pi pi-fw pi-align-left', routerLink: ['/main/processlist']  
                                // },
                                {
                                        label: 'Assessment', icon: 'pi pi-fw pi-book ', routerLink: ['/main/assessment']  
                                },
                                // {
    
                                //     label: 'Register Learner', icon: 'pi pi-fw pi-book ', routerLink: ['/main/register']  
    
                                // },
                            ]
                        },
                      /* {
                            label: 'Process Managent ', icon: 'pi pi-fw pi-align-left',
                            items: [
                                {
                                    label: 'Process List', icon: 'pi pi-fw pi-align-left',
                                    items: [
               ...
               /* {
                    ...
                    items: [
                        {label: 'Learnership Application ', icon: 'pi pi-fw pi-home', routerLink: ['/leanershipapplication'], badge: '', badgeClass: 'p-badge-info'},
                        //{label: 'Dashboard Analytics', icon: 'pi pi-fw pi-home',
                        //    routerLink: ['/favorites/dashboardanalytics'], badge: '2', badgeClass: 'p-badge-success'}
                    ]
                },*/
